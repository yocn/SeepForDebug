...
public class ScreenUtil {
    ...
    public static int[] getViewScreenLocation(View view) {
        ...
        // get the position in the screen, the returned array includes the x&y coordinate point in the left-top corner.
        view.getLocationOnScreen(location);
        return location;
    }

    public static boolean isHeight720dpOrMore(@Nullable Context context) {
        if(context == null){
            return false;
        }
