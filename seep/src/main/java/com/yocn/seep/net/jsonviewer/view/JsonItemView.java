package com.yocn.seep.net.jsonviewer.view;
...
public class JsonItemView extends LinearLayout {
    ...
    public static int TEXT_SIZE_DP = 14;
    ...
    public void showIcon(boolean isPlus) {
        ...
        mIvIcon.setImageResource(isPlus ? R.drawable.ic_add_circle_black_24dp : R.drawable.ic_remove_circle_black_24dp);
    }
